...
slimedungc:
	...
	switch (random) {
		case 1:
			cout << "New legplates unlocked! >>> [Blob Legplates, increases hp by 15%]" << endl;
			bloblegplates = 1;
			break;

		case 2:
			cout << "New boots unclocked! >>> [Blob Boots, increases hp by 10%]" << endl;
			blobboots = 1;
			break;
	}
...
savegame:
	...
	code = code + shpotion + ":";
	code = code + spiclass + sslimyhelmet + sslimychestplate + sbloblegplates + sblobboots;
	cout << code << endl;
